...
apiUser="benjamin.burton"		## Set the API Username here if you want it hardcoded
apiPass="Misfortune13"		## Set the API Password here if you want it hardcoded
jssURL="https://lnbcds01.ads.sothebys.com:8443"		## Set the JSS URL here if you want it hardcoded

## Set the script downloads folder path here.
## Default path is within the JAMF directory in "extension_attributes"
scriptDownloadDir="/Jamf/"
