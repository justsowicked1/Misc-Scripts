...
LOGO="/Library/Application Support/Sothebys/icon.gif"
...
PROMPT_MESSAGE="Your Mac's FileVault encryption key needs to be escrowed by Sotheby's IT.
...
Please contact the Helpdesk for help with your Mac password."
...
FAIL_MESSAGE="Sorry, an error occurred while escrowing your FileVault key. Please contact the Helpdesk."
